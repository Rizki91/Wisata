package com.fahrul.wisata.service;


import com.fahrul.wisata.model.hotel.ModelHotel;
import com.fahrul.wisata.model.hotel.detail.ModelHotelDetail;
...
public interface APIInterfacesRest {
    ...
    @GET("hotel")
    Call<ModelHotel>getHotel();

    @GET("hotel/{id}")
    Call<ModelHotelDetail>getDetail();

    @GET("tempatibadah")
    Call<ModelTempatIbadah>getTempat();

    @GET("kuliner")
    Call<ModelKuliner>getKuliner();

    @GET("kuliner/{id}")
    Call<ModelKulinerDetail>getDataKuliner(@Path("id") int id);

    @GET("wisata")
    Call<ModelWisata>getWisata();
